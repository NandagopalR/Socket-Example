package com.nanda.socketexample.helper;
...
public class LocationHelper implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    public interface OnLocationCompleteListener {
        ...
        void getGoogleApiClient(GoogleApiClient googleApiClient);
    ...
    public void onConnected(Bundle bundle) {
        ...
        onLocationCompleteListener.onConnected(location);
            ...
            case REQUEST_CHECK_SETTINGS:
                switch (resultCode) {
                    case Activity.RESULT_OK:
                        ...
                        onLocationCompleteListener.getGoogleApiClient(mGoogleApiClient);
                        break;
